...
Each returned sample dict must contain at minimum:
    {
...
# normalised sample dict matching the schema described in the module docstring.
# =============================================================================
...
DATASET_PARSERS = {
    ...
    # "ultramedical_10pct": _parse_ultramedical,  # Add when Phase 2 begins
}
...
def load_eval_dataset(
    ...
    Args:
        ...
        hf_path:         HuggingFace dataset path (e.g. "GBaker/MedQA-USMLE-4-options").
        split:           Dataset split to use (e.g. "test").
        max_samples:     If set, cap the number of samples returned.
        sample_fraction: If set (0.0–1.0), randomly sample this fraction of the split.
                         Applied before max_samples.
    ...
    # -------------------------------------------------------------------------
    # Optional fractional sampling (e.g. 10% of UltraMedical)
    # -------------------------------------------------------------------------
